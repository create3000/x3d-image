...
systemSync (`npx . -a -e CANNON -b white -r "0.509086470924499 -0.842639596032569 -0.175469303069548 0.42682311202636" -c LINEAR -x 1.5 -m KHR_PBR_NEUTRAL -i https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Assets/master/Models/BoomBox/glTF/BoomBox.gltf -o tests/boombox.png`);
systemSync (`npx . -l -n -i https://create3000.github.io/media/examples/Rendering/OrderIndependentTransparency/OrderIndependentTransparency.x3d -o tests/oit.png`);
